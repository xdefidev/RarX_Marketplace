...
contract NFTMarketplace {
    ...
    function ListToken(uint256 tokenId, uint256 price, NFTCollection collection) public payable{
    ...
    function executeSale(uint256 tokenId, NFTCollection collection) public payable {
