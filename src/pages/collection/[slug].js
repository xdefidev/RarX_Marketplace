            ...
            <section className="relative bg-light-base pb-12 pt-28 dark:bg-jacarta-800">
                ...
                <div className="container">
                    <div className="text-center">
                        ...
                        <div
                            className="mb-8 inline-flex flex-wrap items-center justify-center rounded-xl border border-jacarta-100 bg-white dark:border-jacarta-600 dark:bg-jacarta-800"
                        >
                            <a
                                href="#"
                            ...
                            >
                                <div
                                    className="mb-1 flex items-center justify-center text-base font-medium text-jacarta-700 dark:text-white"
                                >
