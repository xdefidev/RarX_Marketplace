          ...
          <div className="text-center">
            ...
            {signer_address &&
              <div className="flex justify-center align-middle mb-6 mt-4">
                <a href={user_data?.socials?.length ? user_data?.socials[0] : "#"} target="_blank" className="group mr-4">
                  <svg
                ...
                <a href={user_data?.socials?.length ? user_data?.socials[1] : "#"} target="_blank" className="group">
                  <svg
